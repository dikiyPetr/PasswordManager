...
import com.example.dikiy.passwordmain.Adapters.Get.GetStorage_Item;
...
import com.example.dikiy.passwordmain.Adapters.Model.ShareGetFolder;
...
//        cursor.close();
    ...
    public List<MainItem> loadData(int id) {
        ...
        cursor.moveToFirst();
        while (!cursor.isAfterLast()) {
            list.add(new MainItem(cursor.getString(2), Integer.parseInt(cursor.getString(0)), false, cursor.getString(5)));
            cursor.moveToNext();
        }
        cursor.close();
    ...
    public void setDataPass(GetStorage storage) {
        ...
        for (int i = 0; i < list.size(); i++) {
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getId()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getPass()));
            Log.v("DBcheckname", String.valueOf(list.get(i).getPass().getName()));
            Log.v("DBcheck", String.valueOf(list.get(i).getFolder().getId().toString()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getLogin()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getUrl()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getDescription()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getGroup()));
            Log.v("DBcheck", String.valueOf(list.get(i).getPass().getTag()));
            Log.v("DBcheck", String.valueOf(list.get(i).getClue()));


            Log.v("DBlog1", "insert into passwords  values (" + list.get(i).getPass().getId() + ",'" + list.get(i).getPass().getPass() + "','" + list.get(i).getPass().getName() + "'," + list.get(i).getFolder().getId() + ",'" + list.get(i).getPass().getLogin() + "','" + list.get(i).getPass().getUrl() + "','" + list.get(i).getPass().getDescription() + "','" + list.get(i).getPass().getTag() + "','" + list.get(i).getPass().getGroup() + "','" + list.get(i).getClue() + "')");
    ...
    public GetPass_Item getPass(int id) {
        ...
        cursor.moveToFirst();
        Log.v("kkfdaj12938sap", cursor.getString(1));
        ...
        Log.v("kkfdaj12938sac", cursor.getString(9));
    ...
    public void setDataFolder(ArrayList<GetFolder_Item> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            Log.v("DBlog2", "insert into folders  values (" + list.get(i).getId() + ",'" + list.get(i).getName() + "'," + list.get(i).getParent() + ",'" + list.get(i).getTag() + "','" + list.get(i).getGroup() + "'," + list.get(i).getParent() + ")");
