...
public class GetService_Items_Commands {
    ...
    @Expose
    private List<ParamsItem> params_url=new ArrayList<>();
    @SerializedName("params_body")
    @Expose
    private List<ParamsItem> params_body=new ArrayList<>();
    ...
    public List<ParamsItem> getParamsBody(){
        return params_body;
    }
    public List<ParamsItem> getParamsUrl(){
        return params_url;
    }
    public List<String> getParams_body() {
        ...
        for(int i=0;i<params_body.size();i++){
            list.add(params_body.get(i).getName());
        }
    ...
    public List<String> getParams_url() {
        ...
        for(int i=0;i<params_url.size();i++){
            list.add(params_url.get(i).getName());
        }
        return list;
    }
