...
import com.webant.password.manager.Presenters.AddServiceCommandPresenter;
...
public class AddServiceCommandActivity extends AppCompatActivity {
    TextInputLayout nameTil, commandTil, methodTil, templateBodyTil, templateUrlTil, methodUsedTil;
    EditText name, method, templateBody, templateUrl, methodUsed;
    ...
    private void init() {
        ...
        methodUsedTil = findViewById(R.id.method_usedTILSC);
        methodUsed = findViewById(R.id.method_usedSC);
        ...
        editOrAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (modeEdit)
                    presenter.edit(name.getText().toString(), getIntent().getStringExtra("id"), method.getText().toString(), methodUsed.getText().toString(), templateBody.getText().toString(), templateUrl.getText().toString());
                else
                    loadData(2);
            }
        });
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isNameValid(name.getText().toString()) && isMethodValid(method.getText().toString())) {
                    ...
                    presenter.createCommand(name.getText().toString(), getIntent().getStringExtra("command_id"), method.getText().toString(), methodUsed.getText().toString(), itemsBody, itemsUrl, templateBody.getText().toString(), templateUrl.getText().toString());
                }
            }
        });
